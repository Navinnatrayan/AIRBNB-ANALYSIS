...
if SELECT == "Contact":
    Name = (f'{"Name :"}  {"NAVIN N"}')
    mail = (f'{"Mail :"}  {"navinkrr5322@gmailcom"}')
    Batch = (f'{"Batch Code :"}  {"DTM8"}')
    description = "An Aspiring DATA-SCIENTIST..!"
    social_media = {

        "GITHUB": "https://github.com/Navinnatrayan"
        }

    col1, col2 = st.columns(2)
    col1.image(Image.open("C:/Users/HP/Desktop/airbnb logo.jpg"), width=300)
    col1.image(Image.open("C:/Users/HP/Desktop/guvi.png"), width=300)
    with col2:
        st.header('Airbnb Analysis')
        st.subheader(
